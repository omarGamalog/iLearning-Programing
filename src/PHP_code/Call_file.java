 ...
 * @author Omar
 */
public class Call_file extends javax.swing.JFrame {

    /**
     * Creates new form Call_file
     */
    public Call_file() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Call_file.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
