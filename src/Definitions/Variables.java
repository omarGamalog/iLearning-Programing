...
public class Variables extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("data type  المتغيرات\n\n   double      (100100.400)ارقام عشري \n   int      (50000) ارقام صحيح\n   String   (omar) اسم   \n   float    (10000000.1000) ارقام عشري كبيرة\n   boolean  ()ture and false\n   byte     (123)128 \n   char     (a)حروف\n   long     (123456789)ارقام صحيحة كبير\noperater{\n(+)لجمع  \n(-)لطرح \n(*)ضرب \n(/)القسم\n(%) خارج القسم\n(--)لتنقيس واحد\n(++)لتزيد واحد\n}");
