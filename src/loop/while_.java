 ...
 * @author Omar
 */
public class while_ extends javax.swing.JFrame {

    /**
     * Creates new form while_
     */
    public while_() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("//لو تريد التكرار  \nint i=0;\n   while(i<=10)\n   {\n       System.out.println(\"omar\"+i);\n       i++;\n   }\n");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(while_.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
