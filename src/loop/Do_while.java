 ...
 * @author Omar
 */
public class Do_while extends javax.swing.JFrame {

    /**
     * Creates new form Do_while
     */
    public Do_while() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("//لو الكوندشن خطائ ينفذة مرة واحدة فقط \n  int i=0;\n  do\n   {\n       System.out.println(\"hello\"+i);\n       i++;\n   }\n        while(i<=1); \n        ");
        jScrollPane1.setViewportView(jTextArea1);

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel1.setText("Do_while");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Do_while.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
