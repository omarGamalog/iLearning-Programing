 ...
 * @author Omar
 */
public class class_Template extends javax.swing.JFrame {

    /**
     * Creates new form class_Template
     */
    ...
    private void initComponents() {
        ...
        setTitle("class_Template");

        jPanel1.setBackground(new java.awt.Color(51, 51, 51));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel1.setText("class_Template");
        ...
        jTextArea1.setText("//الاشياء الاثاثية في class\npackage test1;\npublic class Test1 {\n    public static void main(String[] args) {}}");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(class_Template.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new class_Template().setVisible(true);
            }
        });
    }
