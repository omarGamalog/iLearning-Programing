 ...
 * @author Omar
 */
public class Input_massege extends javax.swing.JFrame {

    /**
     * Creates new form Input_massege
     */
    public Input_massege() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Input_massege");

        jPanel1.setBackground(new java.awt.Color(51, 51, 51));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel1.setText("Input_massege");
        ...
        jTextArea1.setText("//لوتريد اضافت رسالة الي الواجها\ndouble one=Double.parseDouble(JOptionPane.showInputDialog(null,\"plase enter number1\"));");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Input_massege.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Input_massege().setVisible(true);
            }
        });
    }
